  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Customer Terms for QuickShaw auto rides." />
        <meta
          name="viewport"
      ...
      <div className={styles.topbar}>
        <div className={styles.topbarInner}>
          ...
          <nav className={styles.menu}>
            ...
            <Link href="/offerings" className={styles.link}>Offerings</Link>
            <a href="/#social" className={styles.link}>Social</a>
            <a href="/#report" className={styles.link}>Report a problem</a>
          </nav>
      ...
      <main className={styles.pageBody}>
        <div className={styles.legalWrap}>
          <p className={styles.updated}>Last updated: <span>19th August 2025</span></p>
          ...
          <p className={styles.intro}>
            QuickShaw (“Company”, “we”, “our”, “us”) provides
            technology-based services through its mobile application to connect
            passengers (“Users”) with independent auto-rickshaw drivers (“you”)
            for on-demand transportation services (“Services”).
          </p>

          <div className={styles.caret} aria-hidden>▾</div>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                ...
                required government permits (insurance, vehicle registration, pollution).
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                ...
                and in compliance with local traffic, transport, and safety laws.
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                Ensure your auto-rickshaw is clean, well-maintained, and safe for passengers.
              </li>
              <li>Behave courteously, professionally, and respectfully with Users.</li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                QuickShaw will collect fares from Users (through digital payments)
                and settle drivers’ earnings when they claim from the wallet.
              </li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                You are solely responsible for any accidents, traffic violations,
                or penalties incurred while providing Services.
              </li>
              <li>
                QuickShaw acts only as a technology intermediary and is not
                liable for loss, damage, injury, or disputes between you and the User.
              </li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                You may also rate Users; however, feedback must be respectful and professional.
              </li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                ...
                and vehicle information for verification, payments, and operational purposes.
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                QuickShaw may suspend or terminate your account immediately in case of:
                <ul className={styles.sublist}>
                  <li>Violation of these T&Cs or applicable laws.</li>
                  <li>Safety concerns, fraud, or misbehavior with Users.</li>
                  <li>Repeated ride cancellations or refusal of trips without valid reasons.</li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.intro}>
              ...
              Updated versions will be posted on the Platform, and your continued
              use will be deemed acceptance of changes.
            </p>
          </section>

          {/* 10 */}
          <section className={styles.section}>
            <h2 className={styles.h2}>10. Governing Law and Dispute Resolution</h2>
            <ul className={styles.list}>
              <li>
                These T&Cs shall be governed by and interpreted under the laws of India.
              </li>
              <li>
                Any disputes will be subject to the exclusive jurisdiction of the
                courts in the city where QuickShaw is registered.
              </li>
            </ul>
          </section>
        </div>
        ...
        <div className={styles.footerInner}>
          ...
          <div className={styles.footCols}>
            <div className={styles.footCol}>
              <a href="/#home" className={styles.footLink}>Home</a>
              <a href="/#about" className={styles.footLink}>About us</a>
              <Link href="/privacy" className={styles.footLink}>Privacy Policy</Link>

              <div className={styles.footSocial}>
                <a aria-label="WhatsApp" href="https://chat.whatsapp.com/LZASDXueL0b0L7plUBIz3k">
                  <img src="/whatsapp.png" alt="" />
                </a>
                <a aria-label="Instagram" href="https://www.instagram.com/quickshaw.co.in/">
                  <img src="/insta.png" alt="" />
                </a>
                <a aria-label="LinkedIn" href="https://www.linkedin.com/company/quickshaw/">
              ...
              <div className={styles.footBadges}>
                ...
                <a href="#"><img src="/app-store.png" alt="Download on the App Store" /></a>
              </div>
            </div>
            ...
            <div className={styles.footCol}>
              <Link href="/terms/customer-autos" className={styles.footLink}>Customer terms - Autos</Link>
              <Link href="/terms/driver-autos" className={styles.footLink}>Driver terms - Autos</Link>
            </div>
          </div>
        </div>
      </footer>
