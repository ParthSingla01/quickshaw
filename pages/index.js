        ...
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            ...
            <div className={styles.searchRow}>
              {/* Pickup */}
              <div className={styles.inputCard} style={{ position: "relative" }}>
  ...
  <div className={styles.highlightsInner}>
    <div className={styles.highlightsTrack}>
      {slides.map((src, i) => (
        ...
        <section id="download" className={styles.download}>
          <div className={styles.downloadInner}>
            ...
            <div className={styles.downloadGrid}>
              {/* Rider app */}
              <a className={styles.app} href="#" aria-label="QuickShaw rider app">
              ...
              {/* Driver app */}
              <a className={styles.app} href="#" aria-label="QuickShaw driver app">
                <div className={styles.appIcon}>
        ...
        <section className={styles.partOfUs} id="community">
          ...
          <div className={styles.footerInner}>
            ...
            <div className={styles.footCols}>
              <div className={styles.footCol}>
                <a href="#home" className={styles.footLink}>
                  Home
                </a>
